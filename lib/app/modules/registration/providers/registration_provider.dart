...
import 'package:event_admin/app/modules/registration/models/registration_model.dart';
import 'package:get/get.dart';
import 'package:http/http.dart' as http;

class RegistrationProvider extends GetConnect {
  Future<RegistrationModel?> createAdmin(String name, String mobileNumber, String password) async {
    final String url =
