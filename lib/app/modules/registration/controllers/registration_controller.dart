import 'package:event_admin/app/modules/registration/providers/registration_provider.dart';
...
class RegistrationController extends GetxController {
  ...
  createAdminAccount(String name, String mobileNumber, String password) async {
    try {
      isLoading(true);
      var registration =
      await RegistrationProvider().createAdmin(name, mobileNumber, password);
